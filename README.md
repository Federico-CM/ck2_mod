...
1117 custom provinces mapped from scratch with correct terrain, regions, de jure structure, and pathing.

1000+ hand-validated characters, each integrated with genealogical logic and cross-checked against historical data.

Full system rewrites, including cultural groups, faith systems, title hierarchies, and scripted flavor events. 
